...
<head>
    ...
    <style>
        ...
        /* Print Styles - Same as view format, landscape A4, single page */
        @media print {
            ...
            * { box-sizing: border-box; }
            ...
            .header-bar, .form-card, .emp-info-card, .payment-info {
                box-shadow: none;
