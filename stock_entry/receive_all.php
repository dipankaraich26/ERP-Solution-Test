            ...
            <div class="form-row" style="grid-template-columns: 1fr 1fr;">
                <div>
                    ...
                    <div style="display: flex; gap: 6px;">
                        <input type="file" name="invoice_attachment" id="ra_invoice_file" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.xls,.xlsx" style="display: none;"
                               onchange="var n=document.getElementById('ra_inv_fname'); n.textContent=this.files[0]?.name||''; n.style.display=this.files[0]?'block':'none';">
                        <button type="button" onclick="document.getElementById('ra_invoice_file').removeAttribute('capture'); document.getElementById('ra_invoice_file').click();"
                        ...
                        <button type="button" onclick="document.getElementById('ra_invoice_file').setAttribute('accept','image/*'); document.getElementById('ra_invoice_file').setAttribute('capture','environment'); document.getElementById('ra_invoice_file').click(); setTimeout(function(){ document.getElementById('ra_invoice_file').setAttribute('accept','.pdf,.jpg,.jpeg,.png,.doc,.docx,.xls,.xlsx'); },500);"
                    ...
                    <small id="ra_inv_fname" style="display:none; margin-top:4px; color:#27ae60; font-size:0.8em;"></small>
                    <small style="color: #888; display: block; margin-top: 4px;">PDF, Image, or Document (max 10MB)</small>
                </div>
                <div>
                    <label>Material Photo</label>
                    <div style="display: flex; gap: 6px;">
                        <input type="file" name="material_photo" id="ra_material_photo" accept="image/*" style="display: none;"
                               onchange="var n=document.getElementById('ra_mat_fname'); n.textContent=this.files[0]?.name||''; n.style.display=this.files[0]?'block':'none';">
                        <button type="button" onclick="document.getElementById('ra_material_photo').removeAttribute('capture'); document.getElementById('ra_material_photo').click();"
                        ...
                        <button type="button" onclick="document.getElementById('ra_material_photo').setAttribute('capture','environment'); document.getElementById('ra_material_photo').click();"
                                style="flex: 1; padding: 8px; border: 2px dashed #0d6efd; border-radius: 6px; background: #e8f0fe; cursor: pointer; font-size: 0.85em; color: #0d6efd; font-weight: 600;">&#128247; Camera</button>
                    </div>
                    <small id="ra_mat_fname" style="display:none; margin-top:4px; color:#27ae60; font-size:0.8em;"></small>
